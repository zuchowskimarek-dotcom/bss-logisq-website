            ...
            <section className={styles.grid}>
                ...
                <div className={styles.card}>
                    <div className={styles.cardImage}>
                        ...
                        <img src="/assets/images/technology/modular-wes.png" alt="LogisQ WES" style={{ maxHeight: '80%' }} />
                    </div>
                ...
                <div className={styles.card}>
                    <div className={styles.cardImage}>
                        ...
                        <img src="/assets/images/products/kolli-scanner-hero.png" alt="Kolli Scanner" style={{ maxHeight: '80%', opacity: 0.8 }} />
                    </div>
                    <div className={styles.cardContent}>
